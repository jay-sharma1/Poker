// Compile this tester (rustc simple_tester_rust.rs) in the same 
// directory as your Poker. source file. Ensure your Poker source 
// file doesn't have a main() function, and the deal function is 
// public (pub fn deal...)
